...
//Map Collections are <key,value> Pairs
//HashMap DataStructure - Hashtable
//Initial Capacity - 16
//Maps can't get cursor so iterator cannot be used directly on Maps , convert to set for using iterator
//Key is heterogeneous , cannot store duplicates
//Values is heterogeneous can store duplicates
//key and values can store null
//It does not stores the order of insertion , it stores the values in sorted of key 
//No of Constructors --> 4
